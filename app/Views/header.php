    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SR<sup>2.0</sup></div>
            </a>
            ...
            <li class="nav-item">
                   <a class="nav-link collapsed" href="#" data-toggle="collapse" 
                    ...
                    <div id="Items">                    
                        <div id="productos" class="collapse" aria-labelledby="headingTwo" 
                        ...
                        data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="<?php echo base_url();?>/lineasproductos">Líneas</a>
                                        <a class="collapse-item" href="#cards.html">Bodegas/Sucursales</a>
                                    </div>
                        ...
                        data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="#cards.html">Vendedores</a>
                                    </div>
